...
/**
 * Princetech\MobileMoney\Mpesa\Database\Entities\MpesaBulkPaymentRequest
 *
 * @property int $id
 ...
 * @property-read \Princetech\MobileMoney\Mpesa\Database\Entities\MpesaBulkPaymentResponse $response
 * @mixin \Eloquent
 */

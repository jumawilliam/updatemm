...
/**
 * Princetech\MobileMoney\Mpesa\Database\Entities\MpesaBulkPaymentResponse
 *
 * @property int $id
 ...
 * @property-read \Princetech\MobileMoney\Mpesa\Database\Entities\MpesaBulkPaymentRequest $request
 * @mixin \Eloquent
 */

...
namespace PrinceTech\MobileMoney\Mpesa\Commands;
...
/**
 * Class Registra
 * @package princetech\MobileMoney\Commands
 */
class Registra extends Command
{
    ...
    {
        return $this->ask('What is your shortcode', \config('princetech.mpesa.c2b.short_code'));
    }

    private function askConfirmationUrl(): string
    {
        return $this->ask('Confirmation Url', \config('princetech.mpesa.c2b.confirmation_url'));
    }

    private function askValidationUrl(): string
    {
        return $this->ask('Validation Url', \config('princetech.mpesa.c2b.validation_url'));
    }
}

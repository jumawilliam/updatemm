...
use Princetech\MobileMoney\Mpesa\Events\StkPushRequestedEvent;
use Princetech\MobileMoney\Mpesa\Exceptions\MpesaException;
use Princetech\MobileMoney\Mpesa\Repositories\Generator;
...
class StkPush extends ApiCore
{
    ...
    public function push($amount = null, $number = null, $reference = null, $description = null)
    {
        ...
        $callback = \config('Princetech.mpesa.c2b.stk_callback');
